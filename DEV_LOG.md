...
[2026-05-12 13:30] Version 1.7.18 - Fixed the event-page transition so required event panel state is committed before rendering, and removed the stale Vite favicon reference that caused a production 404.
