...
```text
Create Ren Takahashi using the shared style prompt. Ren is an adult Japanese male with a composed calm expression, short tousled black hair, refined dark eyes, a long tailored black coat, structured black shirt and trousers, slim gloves, subtle silver hardware, and a quiet poised stance. Keep the design visually compatible with Ken's full-body visual novel asset style while making Ren a distinct new character.
```
